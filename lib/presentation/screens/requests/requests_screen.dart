                  ...
                  child: Row(
                    children: [
                      ...
                      _FilterChipItem(
                        ...
                        isActive: provider.activeFilter == 'En curso',
                        onTap: () => provider.setFilter('En curso'),
                      ),
                      const SizedBox(width: 10),
                      _FilterChipItem(
                        label: AppStrings.completed,
                        isActive: provider.activeFilter == 'Finalizadas',
                        onTap: () => provider.setFilter('Finalizadas'),
                      ),
                      const SizedBox(width: 10),
                      _FilterChipItem(
                        label: AppStrings.cancelled,
                        isActive: provider.activeFilter == 'Canceladas',
                        onTap: () => provider.setFilter('Canceladas'),
                      ),
                    ],
                  ),
                ),
